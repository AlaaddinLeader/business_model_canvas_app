...
use App\Http\Controllers\model_business\BusinessModelExportController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware('auth')->group(function () {
    ...
    // Export routes - High Quality
    Route::get('/business-model/{id}/export/pdf', [BusinessModelExportController::class, 'exportPDF'])
        ->name('business-model.export.pdf');

    Route::get('/business-model/{id}/export/image', [BusinessModelExportController::class, 'exportImage'])
        ->name('business-model.export.image');

    Route::get('/business-model/{id}/export/jpeg', [BusinessModelExportController::class, 'exportJPEG'])
        ->name('business-model.export.jpeg');

    Route::get('/business-model/{id}/export/social', [BusinessModelExportController::class, 'exportSocialMedia'])
        ->name('business-model.export.social');
