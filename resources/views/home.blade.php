    ...
    <style>
        * {
        ...
        .header {
            ...
            align-items: center;
            box-shadow: 0 4px 20px rgba(109, 148, 197, 0.15);
        }
        ...
        .logo-icon {
            ...
            box-shadow: 0 8px 24px rgba(109, 148, 197, 0.35);
        }
        ...
        .start-btn {
            ...
            box-shadow: 0 10px 30px rgba(109, 148, 197, 0.4);
            position: relative;
            overflow: hidden;
        }
        ...
        .start-btn:hover {
            ...
            box-shadow: 0 14px 40px rgba(109, 148, 197, 0.5);
        }
        ...
        .feature-box {
            ...
            padding: 48px 36px;
            border-radius: 24px;
            box-shadow: 0 20px 60px rgba(109, 148, 197, 0.15),
        ...
        .feature-box::before {
            ...
            width: 100%;
            height: 4px;
            background: linear-gradient(90deg, #6D94C5 0%, #5a7ba8 100%);
            transform: scaleX(0);
        ...
        .feature-box:hover {
            ...
            box-shadow: 0 28px 80px rgba(109, 148, 197, 0.25),
                        0 0 0 1px rgba(255, 255, 255, 0.5);
        }
...
<body>
    ...
    <div class="header">
        ...
        <button class="start-btn" onclick="window.location.href='/input'">ابدأ الآن</button>
    </div>
